...
HD_PWD='D:/OneDrive - HKUST Connect/ust/22-23fall/ELEC4320/project/Function_generator/Function_generator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Func_gen_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Func_gen_top.tcl
