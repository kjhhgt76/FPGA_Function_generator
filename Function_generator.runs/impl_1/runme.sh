...
HD_PWD='D:/OneDrive - HKUST Connect/ust/22-23fall/ELEC4320/project/Function_generator/Function_generator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Func_gen_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Func_gen_top.tcl -notrace
