...
#
# Generated by Vivado on Fri Dec 16 04:31:37 +0800 2022
...
# Script info
echo -e "blk_mem_gen_0.sh - Script generated by export_simulation (Vivado v2022.1.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xpm -L blk_mem_gen_v8_4_5 -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot blk_mem_gen_0 xil_defaultlib.blk_mem_gen_0 xil_defaultlib.glbl -log elaborate.log
}
